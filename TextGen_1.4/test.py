...
gen_5 = markov.Markov(text, order=3)
gen2_5 = markov.Markov(text2, order=3)
...
for file in glob.glob(path2):
    ...
    print("valid text", text == gen_0.getText(sequence_0), gen_5.getText(sequence_5) == gen_0.getText(sequence_0))
    print("\n\n")
