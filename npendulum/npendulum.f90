      program npendulum
        ...
        call initalize("initalization.dat", n, sparse, sets, set_size, &
        ...
        do i = 1, sets
          call solver(n, sparse, set_size, integrator, format, &
                      find_energy, l, g, dt, theta, theta_d, theta_dd, &
                      data, energy, hasnan)
          call save_set("output.dat", inital_set, n, sparse, sets, &
                        set_size, integrator, format, find_energy, l, &
                        g, dt, data, energy)
